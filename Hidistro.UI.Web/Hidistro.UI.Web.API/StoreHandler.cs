...
namespace Hidistro.UI.Web.API
{
    ...
    public class StoreHandler : System.Web.IHttpHandler, System.Web.SessionState.IRequiresSessionState
    {
        ...
        public void ProcessRequest(System.Web.HttpContext context)
        {
            ...
            switch (text)
            {
                ...
                case "getStoreInfoList":
                    ...
                    break;
                case "getMemberUpgradeInfo":
                    this.getMemberUpgradeInfo(context);
                    break;
            }
        }
        ...
        private void getMemberUpgradeInfo(System.Web.HttpContext context)
        {
            MemberInfo currentMember = MemberProcessor.GetCurrentMember();
            MemberGradeInfo gradeInfo = MemberProcessor.GetMemberNextGrade(currentMember.UserId);
            if (gradeInfo == null)
            {
                MemberGradeInfo currentGradeInfo = MemberProcessor.GetMemberGrade(currentMember.GradeId);
                context.Response.Write("{\"isMax\":1,\"gradeName\":\"" + currentGradeInfo.Name + "\"}");
            }
            else
            {
                context.Response.Write("{\"isMax\":0,\"gradeName\":\"" + gradeInfo.Name + "\",\"currentPoint\":\"" + currentMember.Points + "\",\"upgradePoint\":\"" + gradeInfo.Points + "\"}");
            }
