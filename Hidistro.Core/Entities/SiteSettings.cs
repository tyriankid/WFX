    ...
    public class SiteSettings
    {
        ...
        public static SiteSettings FromXml(XmlDocument doc)
        {
            ...
            return new SiteSettings(node.SelectSingleNode("SiteUrl").InnerText)
            {
                ...
                thirdWayDiscountInfo = (node.SelectSingleNode("thirdWayDiscountInfo")) == null ? "" : node.SelectSingleNode("thirdWayDiscountInfo").InnerText,
        ...
        public void WriteToXml(XmlDocument doc)
        {
            ...
            SetNodeValue(doc, root, "thirdWayDiscountInfo", this.thirdWayDiscountInfo.ToString());
        ...
        //pro辣 配送距离对应的配送费,起拍价信息.
        public string roadPriceInfo { get; set; }
        //爽爽挝啡 第三方商家以及对应的满减信息
        public string thirdWayDiscountInfo { get; set; }
