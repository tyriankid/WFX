...
function dhAttrBind(t) {
    ...
    var divhtml = "<div id='addAttr" + t + "' class='addAttr' i='" + t + "'>" +
                      ...
                      "<tr><td align='right'>显示设置：</td><td><input type='radio' name='displaySet" + t + "' value='1' />图片</td><td><input type='radio' name='displaySet" + t + "' value='2' />文字</td><td><input type='radio' name='displaySet" + t + "' value='3' />图文</td></tr>" +
                      "<tr><td align='right'>是否换行：</td><td><input type='radio' name='newLine" + i + "' value='true'/>是</td><td colspan='2'><input type='radio' name='newLine" + i + "' value='false' />否(当前无法显示滑动效果，真机上可滑动)</td></tr>" +
    ...
    if ($("#module" + t).find("ul").attr("class").indexOf("newLine") >= 0) {
        $("#addAttr" + t + " input[value='false']").attr("checked", "checked");
    } else {
        $("#addAttr" + t + " input[value='true']").attr("checked", "checked");
    }
    var htmldiv = "";
