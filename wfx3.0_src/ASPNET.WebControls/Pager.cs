...
namespace ASPNET.WebControls
{
    public class Pager : WebControl
    {
        ...
        private void RenderGotoPage(HtmlTextWriter writer, int totalPages)
        {
            ...
            control.Controls.Add(new LiteralControl(string.Format("第{0}/{1}頁 共{2}記錄", this.PageIndex, totalPages.ToString(CultureInfo.InvariantCulture), this.TotalRecords.ToString(CultureInfo.InvariantCulture))));
            ...
            control.Controls.Add(new LiteralControl("頁"));
            ...
            control3.Attributes.Add("value", "確定");
        ...
        private void RenderNext(HtmlTextWriter writer)
        {
            ...
            {
                WebControl control = new WebControl(HtmlTextWriterTag.A);
                control.Controls.Add(new LiteralControl("下一頁"));
        ...
        private void RenderPrevious(HtmlTextWriter writer)
        {
            ...
            {
                WebControl control = new WebControl(HtmlTextWriterTag.A);
                control.Controls.Add(new LiteralControl("上一頁"));
