...
<div class="areacolumn clearfix2">
      <div class="columnright">
          <div class="title">
            ...
            <h1>添加新的代理商</h1>
            <span>当前默认的密码为"888888"</span>
          </div>
        <div class="formitem validator4">
        <ul>
          <li> <span class="formitemtitle Pw_110"><em >*</em>代理商账号：</span>
            <asp:TextBox ID="txtUserName" runat="server" CssClass="forminput" autocomplete="off" />        
      ...
      <ul class="btn Pa_110">
        <asp:Button ID="btnCreate" runat="server" OnClientClick="return PageIsValidEx();" Text="添 加"  CssClass="submit_DAqueding" style="float:left;"/>
        </ul>
      </div>
